...
func LoadEnv() {
	if os.Getenv("GI_MODE") != "release" {
		if err := godotenv.Load(); err != nil {
			log.Printf("Warnig: .env file not found")
		}
	}
	...
	CFG = &Config{
		...
		AllowedOrigins:   getEnv("ALLOWED_ORIGINGS"),
	}
...
func getEnv(key string) string {
	...
	log.Error().Msg("Environment variables " + key + " is not set.")
